      ...
      <div className='container'>
        <div className='row'>
          ...
          <div className='pt-5 pt-md-0 col-md-6'>
            ...
            <p>
              This tool integrates with an existing Notion database and utilizes
              OpenAI´s LLM to ...
            </p>
            ...
            <p>
              You will first need to create a new Notion database with the
            ...
            <p className='small'>
              <em>
                ...
                is not the most secure method of storing keys, but works for
                this demo. Be sure to clear your local storage after each
                working session.
              </em>
            </p>
            <h5>Step 4: Start using the tool!</h5>
            <p>
              You´re all set. Simply input your thoughts, ideas, and todos into
              the input field and let OpenAI´s LLM do the rest. It will
              categorize and prioritize your input and suggest a due date.
            </p>
