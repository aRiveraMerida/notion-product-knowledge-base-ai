      ...
      <div className='row mb-4'>
        <div className='text-center'>
          <h1 className='display-5 fw-bold text-body-emphasis'>
            Notion Product Knowledge Base AI
          </h1>
          {/* <div className="col-lg-6 mx-auto">
                      ...
                      <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
                        ...
                        <a type="button" className="btn btn-outline-secondary btn-lg px-4" href="https://github.com" target="_blank" rel="noopener noreferrer">View on GitHub</a>
                      </div>
                  </div> */}
        </div>
      </div>
      ...
      <footer className='d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top'>
        <div className='col-12 text-center'>
          <p className='mb-3 mb-md-0 text-body-secondary'>
            Made by{' '}
            <a
              href='https://www.linkedin.com/in/alberto-rivera-1b4b0b1b4/'
              target='_blank'
